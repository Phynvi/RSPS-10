...
public class Class131_Sub41_Sub4 extends Class131_Sub41
{
	...
	try {
	    ...
	    Class131_Sub37.aString4608 = "Chargement des interfaces - ";
	    ...
	    Class180.aString2591 = "Attaquer";
	    Class121.aString1585 = "M\u00e9moire attribu\u00e9e";
	    Class176.aString2514 = "vert:";
	    Class220.aString3210 = "Connexion perdue.";
    ...
    public static void method1941(Class130 arg0, int arg1) {
	try {
		...
		Class93.aClass44_1222.method529
		    (arg1 ^ 0x6d79, "--> " + Class23_Sub1_Sub1.aString5085, -1,
		     ...
		     -16777216);
		int i_14_ = -1;
		if ((Class125.anInt1632 % 30 ^ 0xffffffff) < -16)
		    i_14_ = 16777215;
		arg0.method1253
    ...
    public static void method1942(int arg0, Class130 arg1, int arg2,
	...
	do {
		...
		for (;;) {
			...
			if ((i_20_ ^ 0xffffffff) == (arg7 ^ 0xffffffff)
			    ...
			    Class187 class187 = Class55.method612(i, -31);
			    int i_24_
    ...
    public static void method1943(int arg0, int arg1, int arg2, byte arg3,
				  Class130 arg4, int arg5, Class19 arg6,
				  int arg7) {
	do {
	    try {
		anInt6215++;
