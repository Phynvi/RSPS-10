/* Class131_Sub9 - Decompiled by JODE
...
public class Class131_Sub9 extends Class131
{
	...
	try {
	    Class127_Sub1.aString4003 = "Continuar";
	    Class12.aString130 = "Selecionar";
	    Class156.aString2073 = "tremor:";
	    Class53.aString706
		= "Voc\u00ea n\u00e3o pode adicionar a si pr\u00f3prio \u00e0 sua lista de amigos.";
	    Class184.aString2624 = "RuneScape carregando. Aguarde...";
	    Class192.aString2825
		= "Conectando ao servidor de atualiza\u00e7\u00e3o";
	    Class131_Sub2_Sub12.aString5734 = "Remova ";
	    Class44.aString614 = "flash1:";
	    Class165.aString2196 = "Oculto";
	    Class94.aString1246 = "brilho3:";
	    Class126.aString1702 = "Fechar";
	    Class131_Sub10.aString4220 = "Pacote de palavras carregado";
	    ...
	    Class131_Sub2_Sub9.aString5672
		= "N\u00e3o \u00e9 poss\u00edvel encontrar ";
	    Class131_Sub41_Sub5.aString6232 = "brilho2:";
	    Class131_Sub2_Sub11.aString5714 = "M";
	    Class5.aString88 = "Carregando config - ";
	    Class176.aString2514 = "verde:";
	    Class131_Sub41_Sub1.aString6155
		= "Voc\u00ea n\u00e3o pode adicionar a si pr\u00f3prio \u00e0 sua lista de ignorados.";
	    Class23_Sub2_Sub2.aString5195 = "Largar";
	    Class19.aString209 = "Lista de atualiza\u00e7\u00f5es carregada";
	    Class131_Sub2_Sub13.aString5739 = "brilho1:";
	    Class131_Sub2_Sub11.aString5711 = "M";
	    Class88.aString1149 = "K";
	    Class220.aString3210 = "Conex\u00e3o perdida.";
	    Class199.aString2911 = "Iniciando biblioteca 3D";
	    Class110_Sub1.aString3894 = " entrou no jogo.";
	    Class189.aString2761 = "Objeto para membros";
	    Class133.aString1799 = "Carregando padr\u00f5es - ";
	    Class46.aString639 = "qualifica\u00e7\u00e3o: ";
	    Class131_Sub41_Sub6.aString6243 = "Fontes carregadas";
	    Class131_Sub11.aString4238
		= " da sua lista de ignorados primeiro.";
	    Class184.aString2623 = "Tela t\u00edtulo aberta";
	    Class21.aString241 = "Carregando dados da lista de mundos";
	    Class131_Sub18.aString4386 = "Gerenciador de entradas carregado";
	    Class131_Sub2_Sub14.aString5755 = "Carregando tela t\u00edtulo - ";
	    Class131_Sub2_Sub30.aString5980 = "Carregando texturas - ";
	    Class121_Sub2.aString3989
		= " j\u00e1 est\u00e1 na sua lista de amigos.";
	    Class126.aString1699 = "Verificando atualiza\u00e7\u00f5es - ";
	    Class23.aString256 = "amarelo:";
	    anInt4211++;
	    Class131_Sub19.aString4404 = "Examinar";
	    if (arg0 != 3)
		aCharArray4215 = null;
	    Class23_Sub1_Sub2.aString5139 = "Tela t\u00edtulo carregada";
	    Class110.aString1427 = "rolagem:";
	    Class131_Sub2_Sub10.aString5698 = "Texturas carregadas";
	    Class28.aString286 = "Alocando mem\u00f3ria";
	    Class131_Sub10.aString4223 = "flash2:";
	    Class131_Sub41_Sub2.aString6190
		= "Conectado ao servidor de atualiza\u00e7\u00e3o";
	    Class131_Sub2_Sub9.aString5663 = "Mecanismo de som preparado";
	    Class131_Sub41_Sub11_Sub1.aString6555 = "Caminhar para c\u00e1";
	    Class131_Sub6.aString4157 = "Dados da lista de mundos carregados";
	    Class218.aString3199 = "roxo:";
	    Class131_Sub2_Sub30.aString5990 = "Descartar";
	    Class131_Sub2_Sub5.aString5615 = "habilidade: ";
	    Class131_Sub8_Sub1.aString6096 = "Aguarde...";
	    Class131_Sub41_Sub13.aString6329 = "Carregando sprites - ";
	    Class172.aString2294
		= "As vari\u00e1veis do sistema foram carregadas";
	    Class59.aString782 = "Padr\u00f5es carregados";
	    Class131_Sub41_Sub11.aString6300 = "Universo de jogo criado";
	    Class131_Sub2_Sub31.aString6001 = "Sprites carregados";
	    Class120.aString1577
		= "Sua lista de ignorados est\u00e1 cheia. O limite \u00e9 100 usu\u00e1rios.";
	    Class121_Sub2.aString3992 = "Carregando fontes - ";
	    Class171.aString2277 = "onda:";
	    Class203.aString2966 = " ";
	    Class14.aString151 = "brilho3:";
	    Class158.aString2090 = "Usar";
	    Class131_Sub37.aString4608 = "Carregando interfaces - ";
	    Class121_Sub3_Sub1.aString5431 = "K";
	    Class22.aString245 = "vermelho:";
	    Class100.aString1326 = "Biblioteca 3D iniciada";
	    Class180.aString2591 = "Atacar";
	    Class155.aString2068 = "deslizamento:";
	    Class14.aString162 = "Carregando. Aguarde.";
	    Class131_Sub2.aString4103 = " saiu do jogo.";
	    Class153.aString2036 = "Carregando pacote de palavras - ";
	    Class19.aString225 = "Mechscape carregando. Aguarde...";
	    Class34.aString490 = "Config carregada";
	    Class131_Sub2_Sub4.aString5600 = "Interfaces carregadas";
	    Class1_Sub2.aString3510 = "n\u00edvel: ";
	    Class52.aString686 = " da sua lista de amigos primeiro.";
	    Class121.aString1585 = "Mem\u00f3ria alocada";
	    Class131_Sub2_Sub19.aString5823 = "cyan:";
	    Class144.aString1919 = "Virar para c\u00e1";
	    Class182.aString2608 = "Cancelar";
	    Class66.aString890 = "branco:";
	    Class101.aString1328 = "onda2:";
	    Class145.aString1931
		= "Tentando reestabelecer conex\u00e3o. Aguarde.";
	    Class131_Sub41_Sub21_Sub2.aString6593
		= "Selecionar op\u00e7\u00e3o";
	    Class131_Sub3.aString4111 = "Carregando...";
	    Class131_Sub8.aString4184 = "Remova ";
	    Class33.aString457 = "Pegar";
	    Class17.aString179 = "Ok";
	    Class131_Sub2_Sub15.aString5773 = " mais op\u00e7\u00f5es";
	...
	try {
	    anInt4217++;
	    if ((arg0.data.length - arg0.offset ^ 0xffffffff)
		<= -2) {
		int i = arg0.readUnsignedByte(-35);
		if ((i ^ 0xffffffff) <= -1 && (i ^ 0xffffffff) >= -15) {
		    int i_0_;
		    if (i == 14)
			i_0_ = 36;
		    else if (i != 13) {
			...
			if ((Class91.anInt1184 ^ 0xffffffff) != -2
			    && Class91.anInt1184 != 2)
			    Class91.anInt1184 = 2;
			if ((i ^ 0xffffffff) <= -8)
			...
			if (i >= 8)
				...
				= (arg0.readUnsignedByte(86) ^ 0xffffffff) == -2;
			if (i >= 9)
			    Class141.anInt1876 = arg0.readUnsignedByte(-92);
			if ((Class141.anInt1876 ^ 0xffffffff) > -1
			...
			if ((Class171.anInt2284 ^ 0xffffffff) > -1
			    || (Class171.anInt2284 ^ 0xffffffff) < -3)
			...
			if (((Class131_Sub2_Sub10_Sub1.anInt6537 ^ 0xffffffff)
			     > -1)
			    || (Class131_Sub2_Sub10_Sub1.anInt6537
				^ 0xffffffff) < -4)
			    Class131_Sub2_Sub10_Sub1.anInt6537 = 2;
	...
	try {
		...
		if (arg3 == null || (arg3[i_4_] ^ 0xffffffff) != -1) {
	...
	try {
	    ...
	    stream.offset++;
	    i++;
	    int i_7_ = stream.offset;
	    stream.offset += i;
	    int i_8_;
	    for (i_8_ = 0; (((stream.data
			      [i_8_ + stream.offset])
			     ^ 0xffffffff)
			    != -1); i_8_++) {
		/* empty */
	    ...
	    for (int i_10_ = 0; (i_10_ ^ 0xffffffff) > (i_8_ ^ 0xffffffff);
		 i_10_++)
		is_9_[i_10_] = stream.readSignedByte((byte) 127);
	    stream.offset++;
	    i_8_++;
	    int i_11_ = stream.offset;
	    stream.offset += i_8_;
	    int i_12_;
	    for (i_12_ = 0; (((stream.data
			       [stream.offset - -i_12_])
			      ^ 0xffffffff)
			     != -1); i_12_++) {
		/* empty */
		...
		int i_17_ = 1;
		for (int i_18_ = 2;
		     (i_12_ ^ 0xffffffff) < (i_18_ ^ 0xffffffff); i_18_++) {
	    ...
	    byte[] is_23_
		= (i_22_ ^ 0xffffffff) >= -1 ? null : new byte[i_22_ * 2];
	    i_22_ = stream.readUnsignedByte(-122);
	    byte[] is_24_
		= (i_22_ ^ 0xffffffff) < -1 ? new byte[2 * i_22_] : null;
	    int i_25_;
	    for (i_25_ = 0; ((stream.data
			      [i_25_ + stream.offset])
			     != 0); i_25_++) {
		/* empty */
	    }
		...
		if ((anIntArray4206[i_36_] ^ 0xffffffff) != -1) {
		    if (i_31_ == 0) {
			i_35_ = stream.data[i_7_++] + -1;
			if (is.length > i_32_)
			    i_31_ = is[i_32_++];
			else
			    i_31_ = -1;
		...
		if (anIntArray4206[i_38_] != 0) {
		    if ((i_31_ ^ 0xffffffff) == -1) {
			i_37_ = (stream.data[i_11_++] - -16
				 << 1571852866);
			if ((i_32_ ^ 0xffffffff)
			    <= (is_9_.length ^ 0xffffffff))
			    i_31_ = -1;
			else
			    i_31_ = is_9_[i_32_++];
		    }
		...
		if ((i_31_ ^ 0xffffffff) == -1) {
			...
			i_31_ = is_26_[i_32_++];
		    if ((anIntArray4206[i_41_] ^ 0xffffffff) < -1)
	    ...
	    for (int i_42_ = 0; (i_16_ ^ 0xffffffff) < (i_42_ ^ 0xffffffff);
		 i_42_++) {
	    ...
	    if (is_23_ != null) {
		for (int i_46_ = 1;
		     (is_23_.length ^ 0xffffffff) < (i_46_ ^ 0xffffffff);
		     i_46_ += 2)
	    ...
	    for (int i_48_ = 0; (i_16_ ^ 0xffffffff) < (i_48_ ^ 0xffffffff);
		 i_48_++) {
		Class207 class207_49_ = class207s[i_48_];
		if (class207_49_.aByteArray3031 != null) {
		    i_28_ = 0;
		    for (int i_50_ = 2;
			 ((class207_49_.aByteArray3031.length ^ 0xffffffff)
			  < (i_50_ ^ 0xffffffff));
			 i_50_ += 2) {
		...
		is_23_[0] = (byte) i_28_;
		for (int i_54_ = 2;
		     (i_54_ ^ 0xffffffff) > (is_23_.length ^ 0xffffffff);
		     i_54_ += 2) {
	    ...
	    for (int i_79_ = 0; (i_79_ ^ 0xffffffff) > (i_16_ ^ 0xffffffff);
		 i_79_++)
		...
		if ((class207_81_.anInt3024 ^ 0xffffffff) < -1)
