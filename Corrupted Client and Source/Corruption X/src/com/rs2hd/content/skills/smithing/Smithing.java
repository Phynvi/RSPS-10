...
public class Smithing {
    ...
    public void DragonSquaresmithing(Player p) {
        if (!(p.getSkills().getLevel(13) < 75)) {
            if (!(p.getInventory().numberOf(2347) == 0)) {
                if (!(p.getInventory().numberOf(2366) == 0)) {
                    if (!(p.getInventory().numberOf(2368) == 0)) {
                        p.getInventory().deleteItem(2368, 1);
                        p.getInventory().deleteItem(2366, 1);
                        p.getInventory().addItem(1187, 1);
                        p.getSkills().addXp(13, (75 * smithingXpRate));
                        p.animate(713, 0);
                        p.getActionSender().sendMessage("You smith the 2 halfs together...");
                    } else {
                    	 p.getActionSender().sendMessage("you dont have the " + new Item(2368).getDefinition().getName() + " to smith the " + new Item(1187).getDefinition().getName() + "together");
                    }
                } else {
                	 p.getActionSender().sendMessage("you dont have the " + new Item(2366).getDefinition().getName() + " to smith the " + new Item(1178).getDefinition().getName() + "together");
                }
            } else {
            	 p.getActionSender().sendMessage("you need a hammer to smith!");
            }
        } else {
        	 p.getActionSender().sendMessage("you need a smithing level of 75 to make" + new Item(1178).getDefinition().getName());
        }
    }
	private int counter;
