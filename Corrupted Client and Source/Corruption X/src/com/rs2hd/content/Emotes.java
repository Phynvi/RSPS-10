...
public class Emotes {
	...
	public static boolean emote(Player player, int buttonId) {
			...
			player.graphics(1734, 0);
           		...
           		player.animate(10530, 0);
           		player.graphics(1864, 0);
        	} else if (buttonId == 45) { 
			player.animate(11044, 0); 
          		player.graphics(1973, 0);  
        	} else if (buttonId == 46) {
            		player.turkeydelay = 28;
		} else if (buttonId == 47) {
			player.graphics(2037, 0);
			player.animate(11542, 0);
		} else {
			return false;
		}
		return true;
